      ...
      <div className={classes.contactContainer}>
        <div className={classes.contactContent}>
          ...
          <div className={classes.contactInfoContainer}>
            ...
            className={classes.contactButton}><a target="_blank" title="Zum Kontaktformular" tabIndex={0} className={classes.contactFormularText} href={"https://www.antidiskriminierungsstelle.de/DE/Beratung/Beratung_Moeglichkeiten/Formular/Formular1_node.html"}>Zum Kontaktformular</a></button>
          </div>
        </div>
